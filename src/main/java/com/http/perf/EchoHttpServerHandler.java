...
/**
 * Handler implementation for the echo server and http/2 echo server with content aggregation. For http/2 echo server
 * with content aggregation, this receives a {@link FullHttpRequest}, which has been converted by a {@link
 * io.netty.handler.codec.http2.InboundHttp2ToHttpAdapter} before it arrives here. For further details, check {@link
 * Http2OrHttpHandler} where the pipeline is setup.
 */
@Sharable
